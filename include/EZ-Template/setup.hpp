...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {2, 7}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {10, 1}; // Ports, the first number will be used for sensing
